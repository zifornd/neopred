...
workflow EPITOPE_PREDICTION {
    ...
    take:
    salmon              // channel: /path/to/*.sf (qaunt files)
    samplesheet         // channel: /path/to/metasheet.csv
    design              // val: design covariate
    batch               // val: batch covariate
    vcf                 // channel: [ val(meta), [ vcf ] ]
    callers             // val: 'MHCflurry,NetMHCcons,MHCnuggetsII'
    neoantigen_epitope1_lengths // val: "8,9,10,11"
    ...
    emit:
    results      = ch_results           // channel: [ val(meta), tsv and R files ]
